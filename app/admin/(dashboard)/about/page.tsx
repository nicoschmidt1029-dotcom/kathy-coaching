...
export default async function AboutAdmin() {
  ...
  const biography = localized((m) => [m.about.storyMovement, m.about.storyNourish, m.about.storyEducation, m.about.storyMission].map((paragraph) => paragraph.replace(/<\/?em>/g, "")).join("\n\n"));
