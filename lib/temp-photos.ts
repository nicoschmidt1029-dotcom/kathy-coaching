 ...
 * neutrality while Katarina's real photography and video footage are being
...
> = {
  ...
  hero: {
    ...
    alt: "TEMP: generic training atmosphere — will be replaced with a hero photo of Katarina",
    credit: "Unsplash",
  },
  // STOCK PLACEHOLDER – replace with Katarina's own content before launch
  heroMovementDetail: {
