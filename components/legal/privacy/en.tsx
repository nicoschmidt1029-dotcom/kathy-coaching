 ...
 * checked by anyone qualified in Swiss data protection law, and the
...
/**
 * Privacy notice — English (source version).
 *
  ...
  return (
    <>
      <p>
        ...
        <em>{SITE_HOST}</em>, why, how long it&rsquo;s kept, and what rights
      ...
      <p>
        The controller in the sense of Art. 5 lit. j nDSG (and Art. 4(7) GDPR
        for EU visitors) is:
      </p>
      <p>
        Katarina Gröflin
      ...
      <p>
        The site is hosted by Vercel Inc., 340 S Lemon Ave #4133, Walnut, CA
        91789, USA. When you load a page, Vercel receives technical data — IP
        address, timestamp, user-agent, referring URL — to serve the page and
        defend against abuse. This is a legitimate business purpose under Art.
        31 para. 2 lit. c nDSG (and Art. 6(1)(f) GDPR for EU visitors:
        legitimate interest in running the site securely).
      </p>
      <p>
        Vercel acts as a data processor under an executed Data Processing
        Addendum. The transfer to the USA is covered by Standard Contractual
        Clauses; the USA is currently recognised as providing adequate
        protection for EU-U.S. Data Privacy Framework participants (Vercel is
        enrolled). For Swiss data, the transfer relies on Standard Contractual
        Clauses plus the Swiss-U.S. DPF where applicable.
      </p>
      ...
      <ul>
        <li>
          Purpose: reply to your enquiry / pre-contractual measures at your
      ...
      <ul>
        ...
        <li>
          The hero video is served from the same domain, not embedded from a
          third-party player.
        </li>
      </ul>
      ...
      <ul>
        ...
        <li>
          have inaccurate data corrected (Art. 32 para. 1 nDSG / Art. 16 GDPR);
        </li>
        <li>
          have your data deleted (Art. 32 para. 2 lit. c nDSG / Art. 17 GDPR);
        </li>
        <li>object to processing (Art. 30 para. 2 lit. b nDSG / Art. 21 GDPR);</li>
        <li>
          receive your data in a portable format (Art. 28 nDSG / Art. 20 GDPR);
        </li>
        <li>
          lodge a complaint with a supervisory authority — in Switzerland the
