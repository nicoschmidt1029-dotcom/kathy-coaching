    ...
    <article className="overflow-hidden pb-14 md:pb-20">
      <div className="container-page section-pad-top-tight">
        ...
        <div className="mt-10 grid items-start gap-9 md:mt-12 md:grid-cols-12 md:gap-12 lg:gap-16">
          ...
          <section className="md:col-span-7 md:pt-5 lg:pt-9">
            ...
            <ul className="mt-6 border-t border-foreground/12">
              {program.targetAudience.map((item, index) => <li key={item} className="grid grid-cols-[2rem_1fr] gap-4 border-b border-foreground/12 py-3.5 text-foreground/74 sm:grid-cols-[2.5rem_1fr] sm:py-4"><span className="pt-0.5 font-display text-sm text-[var(--clay)]">{String(index + 1).padStart(2, "0")}</span><span className="leading-relaxed">{item}</span></li>)}
            </ul>
