...
type Props = { content?: { eyebrow?: string; headline?: string; body?: string; submitLabel?: string; image?: string | null }; selectedProgram?: string };

export function Contact({ content, selectedProgram }: Props = {}) {
